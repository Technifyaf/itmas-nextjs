...
const data = {
  ...
  features: [
   
    {
      ...
      title: 'Payments',
      text:
        'Track payments across your entire fleet',
    },{
      id: 2,
      imgSrc: Tip,
      altText: 'Secure Contents',
      title: 'Payouts',
      text:
        'Recieve payouts straight into your mobile money account',
    },{
      id: 2,
      imgSrc: Graph,
      altText: 'Secure Contents',
      title: 'Manange and Analyse',
      text:
        'Analyse performance and get summerised reports ',
    },
  ],
};

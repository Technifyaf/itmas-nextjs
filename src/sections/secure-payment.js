...
import PaymentThumb from 'assets/mockuper3.png';
import PaymentPattern from 'assets/payment-pattern.png';

const data = {
  subTitle: 'Security feautures',
  title: 'One time pin proctection',
  description:
    'One time pin authorization for non smart phone users ',
  btnName: 'Learn More',
  btnURL: '#',
};
